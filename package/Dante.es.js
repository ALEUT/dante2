import Immutable, { Map as Map$1 } from 'immutable';
...
var addNewBlockAt = function addNewBlockAt(editorState, pivotBlockKey) {
  ...
  var newBlock = new ContentBlock({
    ...
    depth: 0,
    data: Map$1(getDefaultBlockData(newBlockType, initialData))
  });
  ...
  function DanteEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "initializeState", function () {
      ...
      if (content) {
        ...
        newEditorState = EditorState.set(_this.decodeEditorContent(content), {
